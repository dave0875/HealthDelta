    ...
    *,
    ...
    return "\n".join(
        [
            ...
            "Prioritize clinically or behaviorally meaningful findings, scope, and limitations over operational row counts.",
            "Use row counts only as secondary context for confidence, scope, or data quality.",
            "Lead with what matters in the person's health, fitness, or clinical context.",
