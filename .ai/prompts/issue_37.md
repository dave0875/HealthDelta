...
- Record audit artifacts (prompt/session/review/.ai/time/time.csv) and close with green CI.
...
3) Add required local artifacts (docs/issues, session log, review, .ai/time/time.csv) and close with CI proof.
