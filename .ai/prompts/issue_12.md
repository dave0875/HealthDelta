...
- Audit: session log, review artifact, .ai/time/time.csv entry.
...
- Write `.ai/sessions/YYYY-MM-DD/session_10.md`, `docs/reviews/YYYY-MM-DD_12.md`, update `.ai/time/time.csv`.
