...
- Audit artifacts: session log, review artifact, `.ai/time/time.csv` row.
...
5) Closeout: session log, review notes, .ai/time/time.csv; push; verify CI; comment + close Issue #25.
