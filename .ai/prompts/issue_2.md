...
5) Issue discipline applies to CI work.
   ...
   - Record Codex prompts, CI design decisions, and runner rationale in .ai/
     (prompts/, sessions/, and ADRs as appropriate).

Proceed by:
- Creating the necessary GitHub issues (using the mandatory story template),
- Recording the prompts used to define CI in .ai/prompts/,
- Logging time and LLM usage in .ai/time/time.csv,
