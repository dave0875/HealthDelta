...
- Produce audit artifacts (session log, review, .ai/time/time.csv row) and close only after CI is green with artifacts.
...
- Write session log and AI-on-AI review, update .ai/time/time.csv.
