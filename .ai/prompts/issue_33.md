...
- Produce the required local, share-safe audit artifacts for Issue #33 (prompt, local issue artifact, session log, review, .ai/time/time.csv).
...
- Record immutable prompt `.ai/prompts/issue_33.md` (this file).
- Record session log + review artifact; update `.ai/time/time.csv`.
