...
- Audit artifacts required: session log, review artifact, .ai/time/time.csv entry. Close only when CI is green with artifacts.
...
5) Evidence + closeout
   ...
   - Write `.ai/sessions/YYYY-MM-DD/session_<n>.md` and update `.ai/time/time.csv`.
