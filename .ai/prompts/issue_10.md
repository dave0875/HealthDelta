...
- Audit artifacts: session log, review artifact, .ai/time/time.csv entry.
...
- Write session log `.ai/sessions/YYYY-MM-DD/session_8.md`, AI review `docs/reviews/YYYY-MM-DD_10.md`, and update `.ai/time/time.csv`.
