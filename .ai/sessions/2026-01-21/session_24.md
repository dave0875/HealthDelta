...
- Recorded immutable prompt: `.ai/prompts/issue_24.md`
...
CI evidence
- GitHub Actions run: https://github.com/dave0875/HealthDelta/actions/runs/21232267749 (Linux tests + macOS Xcode job); artifact: `ios-xcresult`.
