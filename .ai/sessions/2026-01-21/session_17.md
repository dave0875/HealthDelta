...
- Recorded immutable prompt: `.ai/prompts/issue_17.md`
...
CI evidence
- CI run (green): https://github.com/dave0875/HealthDelta/actions/runs/21212438527
- macOS artifact: `ios-xcresult`
- Issue #17 evidence comment posted and issue closed.
