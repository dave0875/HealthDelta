...
- Recorded immutable prompt: `.ai/prompts/issue_19.md`
...
CI evidence
- GitHub Actions run: https://github.com/dave0875/HealthDelta/actions/runs/21212911566 (Linux tests + macOS Xcode job); artifact: `ios-xcresult`.
