...
- Added `.ai/prompts/issue_2_followup_1.md` to capture post-hoc execution constraints without changing scope.
...
- Created immutable issue prompt file `.ai/prompts/issue_3.md`.
